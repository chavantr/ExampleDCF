...
import kotlinx.android.synthetic.main.fragment_all_word.view.*
...
class AllWordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_all_word, container, false)
        view.lstWords.layoutManager = LinearLayoutManager(context)

        wordAdapter = WordAdapter(lstWords)

        view.lstWords.adapter = wordAdapter
